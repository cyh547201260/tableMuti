window.LArea = (function () {
    ...
    MobileArea.prototype = {
        init: function (params) {
            ...
            this.triggerIn = document.querySelector(params.triggerIn);
        ...
        setDefault: function (data, code) {
            if (typeof data != 'undefined' && typeof code != 'undefined') {
                this.trigger.value = data.prov.name + '/' + data.city.name;
                this.valueTo.value = code;
                this.value = [data.prov.index, data.city.index, 0];
            }
            return this;
        },
        ...
        bindEvent: function () {
            ...
            function gearTouchEnd(e) {
                ...
                var num = (target["new_" + target.id] - target["old_" + target.id]) / (target["n_t_" + target.id] - target["o_t_" + target.id]);
                var flag = isNaN(num) ? 0 : num;
...
//          _self.triggerIn.value = provinceText + ((cityText) ? ('/' + cityText) : (''));
