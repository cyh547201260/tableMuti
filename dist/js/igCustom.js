//5L+u5pS55pe26Ze0ICAgOiAyMDE4LzAzLzMwCuS/ruaUueS6uuWRmCAgIDog5a6J5a2Q5ra1CuS/ruaUueWGheWuuSAgIDogQlVHIzM2MjkgSFLlop7liqDmiJDlkZjnmoTlp5PlkI3otoXov4cxNeS4quWtl+espuaVsO+8jOaPkOekuuecn+WunuWnk+WQjeWPquiDveaYr+axieWtlw==
/*
 * 
...
{
    var realnameReg=/^[\u4e00-\u9fa5\u9FA6-\u9FCB\u3400-\u4DB5\u20000-\u2A6D6\u2A700-\u2B734\u2B740-\u2B81D\u2E80-\uFE4F·]{2,50}$/;
...
{
    var realnameReg1=/^[\u4e00-\u9fa5\u9FA6-\u9FCB\u3400-\u4DB5\u20000-\u2A6D6\u2A700-\u2B734\u2B740-\u2B81D\u2E80-\uFE4F·]{2,50}$/;

    var realnameReg2=/^([a-zA-Z]){3,50}$/;
    if(name.length==0)
    {
        return 0;
    }
...
function check_telenumber_format(telenumber,can_empty)
{
    ...
    else if (REGEX_MOBILE.test(telenumber))
    {
        return 1;
    }
    else if (!isNaN(telenumber))  //是数字但 非手机号码
    {
        return 3;
    }
    else
